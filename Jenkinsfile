      ...
      parallel {
        stage('PHP 7.2') {
          ...
          steps {
            ...
            sh 'php $WORKSPACE/vendor/bin/parallel-lint --exclude vendor/symfony/polyfill-intl-idn/bootstrap80.php --exclude vendor/symfony/polyfill-intl-normalizer/bootstrap80.php .'
